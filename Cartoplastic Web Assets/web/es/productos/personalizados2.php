...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript">
			...
			arrPieFotos[3] = "En este caso la personalización es sobre vinilo transparente.";
	...
	<div class="separadorHorizontal"></div>
			...
			<div id="pieFoto" style="margin-top: 220px; width: 275px;"></div>
			</div>
					...
					<p>Para  conocer todas las opciones que tenemos para usted, comuníquese con nuestro  equipo al tel&eacute;fono (507) 302-1466, en el correo electr&oacute;nico <a href="mailto:ventas@cartoplastic.com">ventas@cartoplastic.com</a>			        </p>
						</div>
						</div>
			</div>
<br />
